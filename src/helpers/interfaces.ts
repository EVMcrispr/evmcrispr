...
//acl.aragonpm.eth
const ACL_APP_ID: string = "0xe3262375f45a6e2026b7e7b18c2b807434f2508fe1a2a3dfb493c7df8f4aad6a";
// kernel.aragonpm.eth
const KERNEL_APP_ID: string = "0x3b4bf6bf3ad5000ecf0f989d5befde585c6860fea3e574a4fab4c49d1c177d9c";
// evmreg.aragonpm.eth
const EVM_SCRIPT_REGISTRY_APP_ID: string = "0xddbcfd564f642ab5627cf68b9b7d374fb4f8a36e941a75d89c87998cef03bd61";
...
export const getSystemAppNameByAppId = (appId: string): string | null => SYSTEM_APP_ID_NAMES[appId] || null;
