...
/** A token's symbol and decimals, for display only: any failure (no
 *  client, unreadable token) degrades to undefined so a formatter never
 *  masks the message it decorates. */
