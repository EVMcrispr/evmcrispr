...
export const OPERATIONS_ABI = parseAbi([
  ...
  "function powMod(uint256 a, uint256 exponent, uint256 m) pure returns (uint256)",
  "function powMod(uint256 a, int256 exponent, uint256 m) pure returns (uint256)",
  "function powMod(int256 a, uint256 exponent, int256 m) pure returns (int256)",
  "function powMod(int256 a, int256 exponent, int256 m) pure returns (int256)",
  "function addMod(uint256 a, uint256 b, uint256 m) pure returns (uint256)",
  "function addMod(int256 a, int256 b, int256 m) pure returns (int256)",
  "function mulMod(int256 a, int256 b, int256 m) pure returns (int256)",
...
export const OP_SELECTORS = {
  ...
  addMod: sel("addMod(uint256,uint256,uint256)"),
  mulMod: sel("mulMod(uint256,uint256,uint256)"),
