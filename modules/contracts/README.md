...
| [@contracts:codeHash](src/helpers/codeHash.md) | `bytes32` | Code hash of an address, with EXTCODEHASH semantics: `bytes32(0)` for a nonexistent account (zero nonce, balance and code), `keccak256` of the code otherwise. |
