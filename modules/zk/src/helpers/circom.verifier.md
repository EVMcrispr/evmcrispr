...
[zk:prove --circom](../commands/prove.md) resolves through the same cache —
...
- [zk:prove](../commands/prove.md) — prove with `--circom` against the same cached setup
- [@zk:circom.constraints](circom.constraints.md) — size the ptau a circuit needs
