...
// package.
evml.use({ name: "explorer", load: () => import("../src/index") });

const WXDAI = "0xe91d153e0b41518a2ce8dd3d7944fa863463a97d";

/** Just enough WXDAI ABI to decode the fixture deposit() tx and its
 *  Deposit event in the @explorer:tx summary tests. */
const WXDAI_ABI = [
  {
    type: "function",
    name: "deposit",
...
// The @explorer:tx summary enriches via verified names (Blockscout when the
