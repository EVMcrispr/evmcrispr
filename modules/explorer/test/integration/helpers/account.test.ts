  ...
  "@explorer:account",
  {
    ...
    cases: [
      ...
      },
      {
        ...
        input: `@explorer:account(${USDC} mainnet)`,
        validate: (result) => {
          expect(result).to.include("Contract");
    ...
    docCases: [
      {
        ...
        code: `print @explorer:account(0xe91D153E0b41518A2Ce8Dd3D7944Fa863463a97d)`,
      },
    ],
