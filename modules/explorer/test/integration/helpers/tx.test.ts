    ...
    docCases: [
      {
        ...
        code: `print @explorer:tx(0x16df2e878e23ff261844fc9252f6c8bfcd4cb69f9f80895c6a2f01032b228e13)`,
      },
    ],
...
describeHelper(
  "@explorer:tx.from",
  {
    ...
    cases: [
      {
        input: `@explorer:tx.from(${DEPOSIT_TX})`,
    ...
    docCases: [
      {
        ...
        code: `set $sender @explorer:tx.from(0x16df2e878e23ff261844fc9252f6c8bfcd4cb69f9f80895c6a2f01032b228e13)`,
      },
    ],
    sampleArgs: [DEPOSIT_TX, "gnosis"],
  },
...
describeHelper(
  "@explorer:tx.to",
  {
    ...
    cases: [
      {
        input: `@explorer:tx.to(${DEPOSIT_TX})`,
        expected: WXDAI,
      },
    ],
    errorCases: [
      {
        ...
        input: `@explorer:tx.to(${CREATION_TX})`,
    ...
    docCases: [
      {
        ...
        code: `set $target @explorer:tx.to(0x16df2e878e23ff261844fc9252f6c8bfcd4cb69f9f80895c6a2f01032b228e13)`,
      },
    ],
    sampleArgs: [DEPOSIT_TX, "gnosis"],
  },
...
describeHelper(
  "@explorer:tx.value",
  {
    ...
    cases: [
      {
        input: `@explorer:tx.value(${DEPOSIT_TX})`,
        validate: (result) => {
      ...
      },
      {
        ...
        input: `@explorer:tx.value(${FIRST_MAINNET_TX} mainnet)`,
        validate: (result) => {
    ...
    docCases: [
      {
        ...
        code: `set $wei @explorer:tx.value(0x5c504ed432cb51138bcf09aa5e8a410dd4a1e204ef84bfed1be16dfba1b22060 mainnet)`,
      },
    ],
    sampleArgs: [DEPOSIT_TX, "gnosis"],
  },
...
describeHelper(
  "@explorer:tx.calldata",
  {
    module: "explorer",
    cases: [
      {
        input: `@explorer:tx.calldata(${DEPOSIT_TX})`,
        expected: "0xd0e30db0",
      },
    ],
    docCases: [
      {
        ...
        code: `set $data @explorer:tx.calldata(0x16df2e878e23ff261844fc9252f6c8bfcd4cb69f9f80895c6a2f01032b228e13)`,
      },
    ],
    sampleArgs: [DEPOSIT_TX, "gnosis"],
  },
...
describeHelper(
  "@explorer:tx.status",
  {
    ...
    cases: [
      {
        input: `@explorer:tx.status(${DEPOSIT_TX})`,
        validate: (result) => {
    ...
    docCases: [
      {
        ...
        code: `set $ok @explorer:tx.status(0x16df2e878e23ff261844fc9252f6c8bfcd4cb69f9f80895c6a2f01032b228e13)`,
      },
    ],
    sampleArgs: [DEPOSIT_TX, "gnosis"],
  },
...
describeHelper(
  "@explorer:tx.gasUsed",
  {
    ...
    cases: [
      {
        input: `@explorer:tx.gasUsed(${DEPOSIT_TX})`,
        validate: (result) => {
    ...
    docCases: [
      {
        ...
        code: `set $gas @explorer:tx.gasUsed(0x16df2e878e23ff261844fc9252f6c8bfcd4cb69f9f80895c6a2f01032b228e13)`,
      },
    ],
    sampleArgs: [DEPOSIT_TX, "gnosis"],
  },
...
describeHelper(
  "@explorer:tx.fee",
  {
    ...
    cases: [
      {
        // 43741 gas at 1 gwei.
        input: `@explorer:tx.fee(${DEPOSIT_TX})`,
        validate: (result) => {
    ...
    docCases: [
      {
        ...
        code: `set $fee @explorer:tx.fee(0x16df2e878e23ff261844fc9252f6c8bfcd4cb69f9f80895c6a2f01032b228e13)`,
      },
    ],
    sampleArgs: [DEPOSIT_TX, "gnosis"],
  },
...
describeHelper(
  "@explorer:tx.block",
  {
    ...
    cases: [
      {
        input: `@explorer:tx.block(${DEPOSIT_TX})`,
        validate: (result) => {
    ...
    docCases: [
      {
        ...
        code: `set $block @explorer:tx.block(0x16df2e878e23ff261844fc9252f6c8bfcd4cb69f9f80895c6a2f01032b228e13)`,
      },
    ],
    sampleArgs: [DEPOSIT_TX, "gnosis"],
  },
...
describeHelper(
  "@explorer:tx.timestamp",
  {
    module: "explorer",
    cases: [
      {
        input: `@explorer:tx.timestamp(${DEPOSIT_TX})`,
        validate: (result) => {
    ...
    docCases: [
      {
        ...
        code: `set $when @explorer:tx.timestamp(0x16df2e878e23ff261844fc9252f6c8bfcd4cb69f9f80895c6a2f01032b228e13)`,
      },
    ],
    sampleArgs: [DEPOSIT_TX, "gnosis"],
  },
