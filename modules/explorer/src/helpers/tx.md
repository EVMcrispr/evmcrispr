...
print @explorer:tx(0x16df2e878e23ff261844fc9252f6c8bfcd4cb69f9f80895c6a2f01032b228e13)
```
...
- [@explorer:tx.calldata](tx.calldata.md) — raw input data of a transaction
- [@explorer:tx.status](tx.status.md) — whether a transaction succeeded
- [@explorer:account](account.md) — inspect an address
