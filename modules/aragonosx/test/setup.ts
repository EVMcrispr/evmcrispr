...
import { aragonosxHandlers } from "./fixtures/msw-handlers";
...
// package.
evml.use({ name: "aragonosx", load: () => import("../src/index") });

export const server = createTestServer(...aragonosxHandlers);
