...
const OTHER_ADDRESS = "0x64c007ba4ab6184753dc1e8e7263e8d06831c5f6";
  ...
  "@balance",
  {
    cases: [
      ...
      },
      {
        ...
        input: `@balance(XDAI ${OTHER_ADDRESS})`,
        validate: (result) => {
    ...
    docCases: [
      {
        ...
        code: `set $bal @balance(DAI @token(DAI))`,
      },
    ],
