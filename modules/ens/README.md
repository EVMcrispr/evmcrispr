...
| Command | Description |
|---------|-------------|
| [ens:create-subname](src/commands/create-subname.md) | Create a subname under an ENS name you own. *(experimental)* |
...
| [ens:set-fuses](src/commands/set-fuses.md) | Burn NameWrapper fuses on a wrapped ENS name. *(experimental)* |
...
| [ens:unwrap](src/commands/unwrap.md) | Unwrap an ENS name from the NameWrapper. *(experimental)* |
| [ens:wrap](src/commands/wrap.md) | Wrap an ENS name in the NameWrapper. *(experimental)* |
...
| [@ens:fuses](src/helpers/fuses.md) | `number` | Combine NameWrapper fuse names into their uint32 bitmap. *(experimental)* |
| [@ens:fuses.decode](src/helpers/fuses.decode.md) | `array` | Decode a NameWrapper fuse bitmap into its fuse names. *(experimental)* |
| [@ens:fuses.of](src/helpers/fuses.of.md) | `array` | Get the burned fuse names of a wrapped ENS name. *(experimental)* |
