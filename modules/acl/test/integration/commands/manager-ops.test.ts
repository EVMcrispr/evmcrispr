  ...
  cases: [
    {
      ...
      script: `acl:schedule ${MANAGER} ${TOKEN_DISTRO} setDuration(uint256) 1`,
      expectedActions: [
    ...
    },
    {
      ...
      script: `acl:schedule ${MANAGER} ${TOKEN_DISTRO} setDuration(uint256) 1 --when 1700000000`,
      expectedActions: [
        encodeAction(MANAGER, "schedule(address,bytes,uint48)", [
          TOKEN_DISTRO,
          setDurationData,
  ...
  cases: [
    {
      ...
      script: `acl:execute-scheduled ${MANAGER} ${TOKEN_DISTRO} setDuration(uint256) 1`,
      expectedActions: [
    ...
    },
    {
      ...
      script: `acl:execute-scheduled ${MANAGER} ${TOKEN_DISTRO} setDuration(uint256) 1 --value 1e18`,
      expectedActions: [
        encodeAction(
          MANAGER,
  ...
  cases: [
    {
      ...
      script: `acl:cancel-scheduled ${MANAGER} ${SOME_ADDRESS} ${TOKEN_DISTRO} setDuration(uint256) 1`,
      expectedActions: [
