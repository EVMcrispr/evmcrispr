    ...
    errorCases: [
      {
        ...
        input: `@circom:poseidon(${Array(17).fill("1").join(" ")})`,
        error: "@circom:poseidon expects between 1 and 16 inputs, got 17",
      },
      {
        name: "should fail on a non-integer input",
        input: "@circom:poseidon(1.5)",
    ...
    docCases: [
      {
        ...
        code: 'set $commitment @circom:poseidon(1234 5678)\nprint "Commitment:" $commitment',
      },
    ],
  },
